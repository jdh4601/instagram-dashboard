    ...
    <form onSubmit={submit} className="border-t border-border-subtle p-3">
      <div className="flex items-end gap-2 rounded-2xl border border-border-subtle bg-surface px-3 py-2 focus-within:border-brand-400">
        ...
        <textarea
          ...
          className="max-h-96 min-h-36 flex-1 resize-none bg-transparent text-sm leading-relaxed text-neutral-900 outline-none placeholder:text-neutral-400 disabled:cursor-not-allowed"
        />
        {sending ? (
          <button
            type="button"
